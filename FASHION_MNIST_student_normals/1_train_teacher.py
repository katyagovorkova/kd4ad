...
train_ds = tf.data.Dataset.from_tensor_slices((train_data_ae, train_data_ae)).shuffle(7000, reshuffle_each_iteration=True).batch(batch_size, drop_remainder=True)
